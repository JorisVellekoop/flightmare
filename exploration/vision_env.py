...
import numpy as np
import torch
from flightgym import QuadrotorEnv_v1, VisionEnv_v1
...
from exploration_env_wrapper import ExplorationVecEnv
...
def parser():
    ...
    parser.add_argument("--iter", type=int, default=100, help="iter number")
    return parser
...
def main():
    ...
    train_env = ExplorationVecEnv(train_env)
